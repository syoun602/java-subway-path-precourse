...
public class InputValidator {
    ...
    private static final String PATH_SCREEN_INPUT_FORMAT = "[12B]";
    ...
    public static void validatePathScreenInput(String input) {
        if (!input.matches(PATH_SCREEN_INPUT_FORMAT)) {
            throw new IllegalArgumentException(INVALID_SCREEN_INPUT);
        }
    }
}
